...
<div id="app">
    ...
    <nav class="tabs">
        ...
        <button type="buttom" data-paso="2">Informacion</button>
    ...
    <div id="paso-2" class="seccion">
        <h2>tus atos y cita</h2>
        <p class="text-center">coloca tus datos y fecha de tu cita</p>
        <form class="formulario">
            <div class="campo">
                <label for="nombre">nombre</label>
                <input value="<?php echo $nombre; ?>" type="text" name="nombre" id="nombre" placeholder="tu nombre" disabled>
            </div>
            <div class="campo">
